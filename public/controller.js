app.controller("Particle", 
	["$scope", function($scope){

		$scope.data1 = Number(amount);
		$scope.data2 = Number(gravity);
		$scope.data3 = Number(wind);
		$scope.data4 = Number(yV);
		$scope.data5 = Number(xV);
		$scope.data6 = Number(opacity);
		$scope.data7 = Number(radius);
		$scope.data8 = Number(time);
		$scope.data9 = Number(red);
		$scope.data10 = Number(green);
		$scope.data11 = Number(blue);
		$scope.data12 = Number(type);
		
		window.onload = function(){
			particleField($scope.data1, $scope.data2, $scope.data3, $scope.data4, $scope.data5, $scope.data6, $scope.data7, $scope.data8, $scope.data9, $scope.data10, $scope.data11, $scope.data12);
		}
